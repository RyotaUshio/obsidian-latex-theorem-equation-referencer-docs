...
var require_lib = __commonJS({
  "node_modules/obsidian-dataview/lib/index.js"(exports) {
    ...
    (function(Groupings3) {
      ...
      Groupings3.isElementGroup = isElementGroup;
      ...
      Groupings3.isGrouping = isGrouping;
      ...
      Groupings3.count = count;
    })(Groupings2 || (Groupings2 = {}));
    var Link2 = class _Link {
      constructor(fields) {
      ...
      markdown() {
        ...
        if (this.display) {
          ...
          result += "|" + getFileTitle2(this.path);
      ...
      fileName() {
        return getFileTitle2(this.path).replace(".md", "");
      }
    };
    var Widget = class {
      constructor($widget) {
    ...
    function splitOnUnescapedPipe2(link) {
      let pipe = -1;
    ...
    function parseInnerLink(rawlink) {
      let [link, display] = splitOnUnescapedPipe2(rawlink);
...
var deleteAPIAccount = (userPlugin) => {
  ...
  if (accounts) {
    let index = accounts.findIndex((account) => account.manifest.id == userPlugin.manifest.id);
...
var MathIndex = class {
  ...
  updateNames(file) {
    ...
    if (MarkdownPage.isMarkdownPage(page))
      page.$refName = (_a = mainTheorem == null ? void 0 : mainTheorem.$refName) != null ? _a : void 0;
...
var MathIndexManager = class extends import_obsidian23.Component {
   ...
   */
  async updateLinked(files) {
    const toBeUpdated = new Set(files);
